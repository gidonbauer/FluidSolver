...
auto main() -> int {
  ...
  {
    Vector<double, 5> vec{};
    static_assert(vec.is_small, "Expect a Vector of size 5 to be allocated on the stack.");
    ...
    static_assert(mat.is_small, "Expect a 5x5 Matrix to be allocated on the stack.");
  ...
  // ===============================================================================================
  {
    Vector<double, 5, 2> vec{};
    static_assert(vec.is_small,
                  "Expect a Vector of size 5 with 2 ghost cells to be allocated on the stack.");
    ...
    Matrix<double, 5, 5, 2> mat{};
    static_assert(mat.is_small,
                  "Expect a 5x5 Matrix with 2 ghost cells to be allocated on the stack.");
    ...
    Matrix<double, 5, 5, 2, Layout::F> mat_f{};
