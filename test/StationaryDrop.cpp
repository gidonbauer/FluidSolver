...
// -------------------------------------------------------------------------------------------------
#if 0
auto check_vf_ghost(const FS<Float, NX, NY, NGHOST>& fs, const Field2D<Float, NX, NY, NGHOST>& vf) {
  bool left_good = true;
...
auto main() -> int {
  ...
  Field2D<Float, NX + 1, NY, NGHOST> delta_pj_u_stag{};
  Field2D<Float, NX, NY + 1, NGHOST> delta_pj_v_stag{};
